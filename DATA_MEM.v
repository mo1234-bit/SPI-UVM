...
assign rs2 =instruction[24:20] ;
 ...
 always @(posedge clk ) begin
      if (!rst || !local_rst_data_mem) begin
 data_out<=0;     
 instruction_out<=0;
      end
      else begin
      instruction_out<=instruction;
      if(instruction[31:25]==7'b0000011||instruction[31:25]==7'b0001101)
      ...
      if(instruction[31:25]==7'b0001101&&address>255)
      data_out<=0;
 end
