...
// Module Name: Decoder block
// Project Name: Graduation project
//Designer: Mohamed Ahmed & Abdullah sleem
/////////////////////////////////@CopyRights/////////////////////////////////////////////////
        ...
        if (!rst_n) begin
            ...
            case (state)
                ...
                DECODE: begin
                    ...
                    xs2 <= instruction[12];
                    rd  <= instruction[11:7];
                    if(instruction[28:25]==4'b1101)
                    index<={instruction[31:29],instruction[14],instruction[11:9],instruction[1:0]};
                    else 
                    index<=0;
